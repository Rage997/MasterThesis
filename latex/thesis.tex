...
%TODO talk a little about the smoother

%TODO talk a little about how to estimate the parameters
...
\begin{algorithm}[H]
\For{k=1...s}{
  E-Step: Kalman Filter  \ref{eq:ext_kalmann_prediction} + \ref{eq:ext_kalmann_update} \;
  M-Step: Smoothing \;
  Estimate paramters
}
\caption{Extended Kalmann Filter}
