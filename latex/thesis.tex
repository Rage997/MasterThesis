...
%TODO plot of just a couple of nodes to show trajectories  
...
In Fig. \ref{fig:trajectories_species} I report the trajectories taken by 100 randomly selected species and in Fig. \ref{fig:trajectories_region} the analogous plot for regions. A in-depth look at these trajectories suggest that there are patterns in the movements of region and species in the latent space. We now focus on analysing these clusters. 
