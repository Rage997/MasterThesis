...
We fitted our model on $15947$ alien species invasions from $1850$ to $2010$. In the dataset there are $1724$ species and $153$ regions. In Fig. \ref{fig:latentspace_config} the initial and final configuration of the latent space are reported. Unfortunately, due to the high number of nodes, it's hard to see the evolution of the latent space. In Fig. \ref{fig:trajectories} I report the trajectories taken by 100 randomly selected species. From this image we can clearly see how there are some clusters in the trajectories. We are interested in studying these clusters which species have the tendecy to co-invade regions. 
...
\begin{figure}[ht] 
  ...
  \begin{minipage}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=\linewidth]{latentspace_tf0.png} 
%    \caption{Initial configuration.} 
    \vspace{4ex}
  \end{minipage}%%
  \begin{minipage}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=\linewidth]{latentspace_tf15.png} 
...
%    \vspace{4ex}
%  \end{minipage} 
\caption{Latent space initial (left) and final (right) configurations.}
...
The clusters size are ...

%TODO remove the non-assigned cluster
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    ...
    \caption{Cluster in the latent space initial configuration.}     
