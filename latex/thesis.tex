...
%TODO go to model section
%set exponentially distributed as the distance species-region in the latent space
...
%TODO cover the linear KF here

%TODO move all this to model section
