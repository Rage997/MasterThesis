...
The expectation $E[Q(\theta^n)]$ is typically computationally untractable. Furthermore, it's complexity increases with the amount of data feeded to the model. There are many approaches available to estimate this quantity \cite{book:EMBook}. In this paper we are interested in a approach called Kalman Filter.
