...
We fitted our model on $15947$ alien species invasions from $1850$ to $2010$. In the dataset there are $1724$ species and $153$ regions. In Fig. \ref{fig:latentspace_config} the initial and final configuration of the latent space are reported. Unfortunately, due to the high number of nodes, it is hard to see the evolution of the latent space. In Fig. \ref{fig:trajectories} I report the trajectories taken by 100 randomly selected species. From this image we can clearly see how there are some clusters in the trajectories. We are interested in studying these clusters which species have the tendecy to co-invade regions. 
